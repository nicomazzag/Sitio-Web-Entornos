<header>
    <nav class="navbar navbar-expand-md bg-primary">
        <div class="container-fluid">
            ...
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#menu" aria-controls="menu" aria-expanded="false" aria-label="Abrir barra navegación">
            ...
            <div class="collapse navbar-collapse" id="menu">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white" href="../PaginaGeneral/Promociones.php">Promociones</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="#contactanos">Contáctanos</a>
                    </li>
                    <li>
                        <a class="nav-link text-white" href="../Logeo/Iniciar_sesion.php">Iniciar sesión</a>
                    </li>
                </ul>
            </div>
        </div>
