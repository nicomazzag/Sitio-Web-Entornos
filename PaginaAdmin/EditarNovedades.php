...
<body>
    ...
    ?>
    <div class="container">
        <h1 class="display-2">Editando Novedad XXX</h1>
        <form action="" method="post">
            <div class="row">
                <div class="form-group col-md-4 mt-2">
                    <label for="textoNov">Descripcion de la novedad</label>
                    <input class="form-control" type="text" id="textoNov" name="textoNovedad" placeholder="Ingrese el texto de la novedad" value="Texto novedad anterior">
                </div>
                <div class="form-group col-md-4 mt-2">
                    <label for="fechaDesde">Ingrese la fecha de inicio</label>
                    <input class="form-control" type="date" id="fechaDesde" name="fechaDesdeNov" value="2000-01-01"> <!-- dejar fecha ya fijada de la promo antes de editar -->
                </div>
                <div class="form-group col-md-4 mt-2">
                    <label for="fechaHastaNov">Ingrese la fecha de fin</label>
                    <input class="form-control" type="date" id="fechaHastaNov" name="fechaHastaNov" value="2000-01-01"><!-- dejar fecha ya fijada de la promo antes de editar -->
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="accordion" id="accordionExample">
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                ...
                                <!-- dejar fijado todos los clientes ya selecionados antes de editar -->
                            </h2>
